  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Modal visible={navVisible} transparent animationType="none">
        ...
        >
          <Animated.View
            style={[styles.navPane, { left: slideAnim }]}
      ...
      <View style={styles.cateringBannerContainer}>
        ...
        <View style={styles.cateringBannerOverlay}>
          ...
          <Text style={styles.cateringBannerSubtitle}>
            Tell us what and how many and we will bring/provide the food
          </Text>
          <TouchableOpacity
            style={styles.cateringBannerButton}
            onPress={() => router.push("/(tabs)/catering")}
          >
            <Text style={styles.cateringBannerButtonText}>
